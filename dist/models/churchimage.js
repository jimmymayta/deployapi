...
const ChurchImageSchema = new mongoose_1.Schema({
    churchimagecode: {
        type: String,
        lowercase: true,
        trim: true,
        unique: true,
        default: null,
        required: [true, "Church Image Code"],
    },
    churchimagename: {
        type: String,
        lowercase: true,
        ...
        unique: true,
        default: null,
        required: [true, "Church Image Name"],
    },
    churchimagefile: {
        type: String,
        lowercase: true,
        ...
        unique: true,
        default: null,
        required: [true, "Church Image File"],
    },
    churchimagewidth: {
        type: String,
        lowercase: true,
        ...
        unique: false,
        default: null,
        required: [true, "Church Image Width"],
    },
    churchimageheight: {
        type: String,
        lowercase: true,
        ...
        unique: false,
        default: null,
        required: [true, "Church Image Height"],
    },
    churchimageextension: {
        type: String,
        lowercase: true,
        trim: true,
        unique: false,
        default: null,
        required: [true, "Church Image Extension"],
    },
    idchurch: {
