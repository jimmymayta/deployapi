...
const MemberHistorySchema = new mongoose_1.Schema({
    memberhistorycode: {
        type: String,
        lowercase: true,
        trim: true,
        unique: true,
        default: null,
        required: [true, "Member History Code"],
    },
    memberhistorytitle: {
        type: String,
        lowercase: true,
        ...
        unique: false,
        default: null,
        required: [false, "Member History Title"],
    },
    memberhistorydescription: {
        ...
        unique: false,
        default: null,
        required: [false, "Member History Description"],
    },
    memberhistorydate: {
        type: String,
        lowercase: true,
        ...
        unique: false,
        default: null,
        required: [false, "Member History Date"],
    },
    idmember: {
