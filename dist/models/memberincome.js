...
const MemberIncomeSchema = new mongoose_1.Schema({
    memberincomecode: {
        type: String,
        lowercase: true,
        trim: true,
        unique: true,
        default: null,
        required: [true, "Member Income Code"],
    },
    idmember: {
...
}, { collection: "memberincome" });
exports.default = (0, mongoose_1.model)("MemberIncome", MemberIncomeSchema);
//# sourceMappingURL=memberincome.js.map