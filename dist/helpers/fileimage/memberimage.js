...
exports.memberimagedeletefile = exports.memberimageuploadfile = void 0;
...
const memberimageuploadfile = (file, filedir) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (width === height) {
        yield (0, sharp_1.default)(file.tempFilePath)
            .resize(height, Math.round((50 / 100) * height) + height)
            .toFile(pathfileimage);
    }
    if (width > height) {
        yield (0, sharp_1.default)(file.tempFilePath)
            .resize(width, Math.round((50 / 100) * width) + width)
            .toFile(pathfileimage);
    }
    if (width < height) {
        yield (0, sharp_1.default)(file.tempFilePath)
